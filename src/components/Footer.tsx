  ...
  return (
    <footer className="bg-[#00AC94] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        <StaggerContainer
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_1fr] gap-10 sm:gap-12"
          staggerDelay={0.1}
        >
          {/* Brand */}
          <StaggerItem>
            <div>
              <Link href="/" className="flex items-center gap-3 mb-6">
                <Image
                  ...
                  width={200}
                  height={200}
                  className="bg-white rounded-2xl p-2 hover:scale-105 transition-transform duration-300"
                />
              </Link>
              <div className="flex items-center gap-3 mt-6">
                <a
                  href="#"
                  className="w-9 h-9 rounded-full bg-white/20 hover:bg-white/30 hover:scale-110 flex items-center justify-center transition-all duration-300"
                  aria-label="Facebook"
                >
          ...
          <StaggerItem>
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <Link
                    href={"/services/distribution" as any}
                    className="text-sm text-white hover:text-white/80 hover:translate-x-1 inline-block transition-all duration-300"
                  >
                ...
                <li>
                  <Link
                    href={"/services/children-hospital" as any}
                    className="text-sm text-white hover:text-white/80 hover:translate-x-1 inline-block transition-all duration-300"
                  >
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <a
                      href="tel:+97698009898"
                      className="text-sm text-white hover:text-white transition-colors"
                    >
                      {t("phone")}
                    </a>
                    <a
                      href="tel:+97699822129"
                      className="text-sm text-white hover:text-white transition-colors"
                    >
                      {t("phone2")}
                    </a>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a
                    href="mailto:anhnii.nahia@gmail.com"
                    className="text-sm text-white hover:text-white transition-colors"
                  >
                    {t("email")}
                  </a>
        ...
        <FadeInUp delay={0.4}>
          <div className="mt-14 pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs sm:text-sm text-white">{t("copyright")}</p>
          </div>
        </FadeInUp>
      </div>
    </footer>
