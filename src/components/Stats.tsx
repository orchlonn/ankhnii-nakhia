const stats = [
  {
    ...
    desc: "2005 оноос хойш эрүүл мэндийн салбарт тасралтгүй үйлчилж байна",
  },
  {
    value: "500+",
    label: "Бүтээгдэхүүний нэр төрөл",
    desc: "Олон улсын стандартад нийцсэн эм, эмнэлгийн хэрэгслийг нийлүүлдэг",
  },
  {
    value: "15+",
    label: "Импортын улс орон",
    desc: "Дэлхийн 15 гаруй орноос шууд импортлон нийлүүлнэ",
  },
];
